...
# ARG_HELP([Run first-time user setup for a new GraphDB instance and/or set up a GraphDB graph database. For more information, see https://neurobagel.org/infrastructure/.])
# ARGBASH_GO()
...
print_help()
{
	printf '%s\n' "Run first-time user setup for a new GraphDB instance and/or set up a GraphDB graph database. For more information, see https://neurobagel.org/infrastructure/."
