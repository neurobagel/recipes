...
class Dataset(Bagel):
    ...
    # NOTE: We exceptionally allow hasPortalURI in JSONLDs here to support legacy datasets for the n-API only,
    # to ensure it can return dataset portal info from nodes with JSONLDs that have not yet been
    # updated to use the new dataset attributes
